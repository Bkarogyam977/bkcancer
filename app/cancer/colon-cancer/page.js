...
export default function ColonCancerPage() {
  ...
  return (
    <>
      <section className="relative h-[40vh] min-h-[350px]" style={{ background: "linear-gradient(135deg, #27AE60, #1e8449)" }}>
        <div className="absolute inset-0 bg-black/30"></div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="text-white">
            <div className="text-6xl mb-4">💩</div>
            <h1 className="text-4xl md:text-5xl font-bold mb-4" style={heading}>Colon Cancer</h1>
            <p className="text-lg opacity-90 max-w-2xl" style={body}>Understanding colon cancer: symptoms, causes, and integrative treatment approaches</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed" style={body}>Colorectal cancer begins in the colon or rectum. It often starts as polyps that become cancerous over time. Regular screening can detect and remove polyps before they become cancer. It's the third most common cancer worldwide.</p>
              </div>
              ...
              <div className="mb-8">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <li className="flex items-start gap-2"><span className="text-[#F4A118]">•</span><span className="text-gray-700">Age (over 50)</span></li>
                  <li className="flex items-start gap-2"><span className="text-[#F4A118]">•</span><span className="text-gray-700">Family history</span></li>
                  <li className="flex items-start gap-2"><span className="text-[#F4A118]">•</span><span className="text-gray-700">Inflammatory bowel disease</span></li>
                  ...
                  <li className="flex items-start gap-2"><span className="text-[#F4A118]">•</span><span className="text-gray-700">Sedentary lifestyle</span></li>
                </ul>
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-gradient-to-br from-[#0D3B38] to-[#1a5c57] rounded-2xl p-6 text-white mb-6">
                ...
                <p className="text-white/90 text-sm leading-relaxed" style={body}>Ayurveda focuses on improving digestion, detoxifying the colon, and strengthening the immune system. Herbs like Triphala, Haridra, and Kutki are commonly used for colon health and detoxification.</p>
              </div>
              <div className="bg-gray-50 rounded-2xl p-6">
                <h3 className="text-lg font-bold mb-4" style={{ color: "#0D3B38", ...heading }}>💊 Treatment Options</h3>
                <ul className="space-y-2">
                  <li className="text-sm text-gray-700">✓ Surgery (colectomy)</li>
