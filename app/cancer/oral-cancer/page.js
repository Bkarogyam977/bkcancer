      ...
      <section className="relative h-[40vh] min-h-[350px]" style={{ background: "linear-gradient(135deg, #E67E22, #b85e0a)" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="text-white">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4" style={heading}>Oral Cancer</h1>
            <p className="text-lg opacity-90 max-w-2xl" style={body}>Understanding oral cancer: symptoms, causes, and integrative treatment approaches</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed" style={body}>Oral cancer includes cancers of the lips, tongue, cheeks, floor of the mouth, hard palate, and gums. It's often associated with tobacco and alcohol use. Early detection through regular dental check-ups can significantly improve outcomes.</p>
              </div>
              ...
              <div className="mb-8">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <li className="flex items-start gap-2"><span className="text-[#F4A118]">•</span><span className="text-gray-700">Poor oral hygiene</span></li>
                  <li className="flex items-start gap-2"><span className="text-[#F4A118]">•</span><span className="text-gray-700">Sun exposure (lip cancer)</span></li>
                </ul>
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-gradient-to-br from-[#0D3B38] to-[#1a5c57] rounded-2xl p-6 text-white mb-6">
                ...
                <p className="text-white/90 text-sm leading-relaxed" style={body}>Ayurvedic treatment focuses on detoxifying the oral cavity, reducing inflammation, and strengthening the immune system. Herbs like Yashtimadhu, Triphala, and Neem are beneficial for oral health.</p>
              </div>
              <div className="bg-gray-50 rounded-2xl p-6">
                <h3 className="text-lg font-bold mb-4" style={{ color: "#0D3B38", ...heading }}>💊 Treatment Options</h3>
                <ul className="space-y-2">
                  <li className="text-sm text-gray-700">✓ Surgery to remove tumor</li>
                  ...
                  <li className="text-sm text-gray-700">✓ Reconstructive surgery</li>
                </ul>
              </div>
            </div>
          </div>
