...
export default function KidneyCancerPage() {
  const symptoms = [
    "Blood in urine",
      ...
      <section className="relative h-[40vh] min-h-[350px]" style={{ background: "linear-gradient(135deg, #3498DB, #1f618d)" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 h-full flex items-center">
          <div className="text-white">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4" style={heading}>Kidney Cancer</h1>
            <p className="text-lg opacity-90 max-w-2xl" style={body}>Understanding kidney cancer: symptoms, causes, and integrative treatment approaches</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed" style={body}>Kidney cancer begins in the kidneys, which filter blood and produce urine. Renal cell carcinoma is the most common type, often detected incidentally during imaging tests. Early-stage kidney cancer may not cause symptoms and is often found during routine checkups.</p>
              </div>
              ...
              <div className="mb-8">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <li className="flex items-start gap-2"><span className="text-[#F4A118]">•</span><span className="text-gray-700">High blood pressure</span></li>
                  <li className="flex items-start gap-2"><span className="text-[#F4A118]">•</span><span className="text-gray-700">Family history</span></li>
                  <li className="flex items-start gap-2"><span className="text-[#F4A118]">•</span><span className="text-gray-700">Advanced kidney disease</span></li>
                </ul>
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-gradient-to-br from-[#0D3B38] to-[#1a5c57] rounded-2xl p-6 text-white mb-6">
                ...
                <p className="text-white/90 text-sm leading-relaxed" style={body}>Ayurvedic treatment focuses on supporting kidney function, reducing inflammation, and detoxifying the body. Herbs like Punarnava, Gokshura, and Varuna are beneficial for kidney health and urinary system support.</p>
              </div>
              <div className="bg-gray-50 rounded-2xl p-6">
                <h3 className="text-lg font-bold mb-4" style={{ color: "#0D3B38", ...heading }}>💊 Treatment Options</h3>
                <ul className="space-y-2">
                  <li className="text-sm text-gray-700">✓ Partial or radical nephrectomy</li>
                  <li className="text-sm text-gray-700">✓ Ablation therapy (cryoablation, radiofrequency)</li>
                  <li className="text-sm text-gray-700">✓ Targeted therapy drugs</li>
                  <li className="text-sm text-gray-700">✓ Immunotherapy</li>
                  <li className="text-sm text-gray-700">✓ Radiation for symptom relief</li>
                </ul>
              </div>
            </div>
          </div>
