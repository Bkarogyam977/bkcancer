...
const navLinks = [
  ...
  { href: "/blog", label: "Blog" },  // ✅ Added Blog section
      ...
      <nav style={{ backgroundColor: "white", borderBottom: "1px solid #e5f0ec" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            {/* Logo with Properly Cropped Image */}
            <Link href="/" className="flex items-center gap-2 sm:gap-4">
              <div className="relative w-12 h-12 sm:w-16 sm:h-16">
                <Image
                  src="https://bk-erp-file.s3.amazonaws.com/offer-banners/offersbanners/2026/3/21/Gemini_Generated_Image_sqqv19sqqv19sqqv1.png"
                  alt="BK Cancer Care Logo"
                  fill
